...
describe('CommitteeMemoQuestionsComponent', () => {
    ...
    describe('Section Is Valid', () => {
        ...
        describe('verifyCreditModelSelected()', () => {
            it('should call function with rating committee workflow disabled', () => {
                ...
                // Set isRatingCommitteeWorkflow to false
                component.isRatingCommitteeWorkflow = false;
            ...
            it('should call function with rating committee workflow enabled', () => {
                ...
                // Set isRatingCommitteeWorkflow to true
                component.isRatingCommitteeWorkflow = true;
    ...
    describe('ngOnInit', () => {
        it('should initialize rating committee workflow flags', () => {
            ...
            expect(component.isSovRatingCommitteeWorkflow).toBe(true);
            expect(component.isSubSovRatingCommitteeWorkflow).toBe(true);
            expect(component.isSovMdbRatingCommitteeWorkflow).toBe(true);
        });
    });
